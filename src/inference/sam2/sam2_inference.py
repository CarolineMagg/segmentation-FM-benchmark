########################################################################################################################
# Inference script for SAM2 in image mode
...
def run_inference_sam2(json_file: Union[Path, str], output_folder: Union[Path, str], prompt_type: list[str],
                       number_prompts: int, number_random_prompts: int, model_type: str = "sam2_new_hiera_base_plus",
    ...
    # meta data json
    all_meta_data = {"model": "SAM2 image", "model_type": model_type,
...
if __name__ == '__main__':
    ...
    run_inference_sam2(json_file=args.json_file,
